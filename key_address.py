...
def base58_encode(data):
    ...
    # in case we receive a string, we assume it would be a hex number in a string
    # and convert it. We will count leading zeros as well to have it added to the
...
def generate_pubkey(privkey):
    ...
    # stolen from https://github.com/Destiner/blocksmith/blob/master/blocksmith/bitcoin.py
